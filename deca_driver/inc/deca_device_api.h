...
#define DWT_REENABLE_ON_DLY_ERR     2  // if delayed RX failed due to "late" error then this flag will re-enable RX immediately if set else RX is off on function return
