...
// #define DW1000_CS GET_PIN(E,2)
#define DW1000_RST GET_PIN(F, 8)
#define DW1000_IRQ GET_PIN(F, 9)

#define DW1000_DW_RST_on rt_pin_write(DW1000_RST, PIN_LOW)   //(GPIOE->BSRR = GPIO_PIN_4)
#define DW1000_DW_RST_off rt_pin_write(DW1000_RST, PIN_HIGH) //(GPIOE->BSRR = (uint32_t)GPIO_PIN_4 << 16U)

#define DW1000_CS_off() //(GPIOE->BSRR = (uint32_t)GPIO_PIN_2 << 16U)/*0*/
#define DW1000_CS_on()  //(GPIOE->BSRR = GPIO_PIN_2)/*1*/
